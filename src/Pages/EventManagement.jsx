...
function EventManagement() {
        ...
        const eventData = {
          ...
          image:
            data.images && data.images.length > 0
              ? data.images[0]
              : "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=200&h=200&fit=crop", // First image from array with fallback
    ...
    <div className="bg-[#F8F9FA] border border-gray-200 rounded-lg p-4 mb-4 shadow-sm">
      <div className="flex space-x-4 mb-3">
        <div className="relative w-14 h-14 flex-shrink-0">
          {imageLoading && (
            <div className="absolute inset-0 bg-[#3B82F640] rounded-md animate-pulse"></div>
          )}
          <img
            src={event.image}
            alt={event.title}
            ...
            onError={(e) => {
              ...
              e.target.src = "https://images.unsplash.com/photo-1492684223066-81342ee5ff30?w=200&h=200&fit=crop";
            }}
          />
        </div>
  ...
  // Remove the DesktopEventCard component
      ...
      <div className="flex-1">
        ...
        <div className="w-full h-16 shadow-custom bg-[#FAFAFB] flex items-center justify-between px-4 lg:px-6">
          <div className="flex items-center">
            ...
            <h1 className="text-lg sm:text-xl font-bold text-black lg:hidden font-PlusJakartaSans">
              Event Management
            </h1>
          </div>
          <button
                  ...
                  <div key={event.id} className="bg-[#4BADE61A] rounded-3xl shadow-sm border p-6">
                    <div className="flex space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        {/* Description */}
                        <p className="text-black font-WorkSansMedium text-sm leading-relaxed mb-4">
                          {event.description}
                        </p>
