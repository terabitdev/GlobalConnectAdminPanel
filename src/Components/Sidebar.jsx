...
// const Sidebar = forwardRef(({ activeItem = "Dashboard", onItemClick }, ref) => {
//   const [isOpen, setIsOpen] = useState(false);

//   const sidebarItems = [
//     { name: "Dashboard", iconPath: "/assets/dashboard.svg" },
//     { name: "Users", iconPath: "/assets/user.svg" },
//     { name: "Event Management", iconPath: "/assets/event.svg" },
//     { name: "Restaurant Management", iconPath: "/assets/restaurant.svg" },
//     { name: "Tips Management", iconPath: "/assets/tips.svg" }
//   ];
...
//       {/* Sidebar */}
//       <div className={`
//         fixed lg:relative top-0 left-0 h-full w-[17rem] bg-white shadow-custom flex flex-col z-50 
